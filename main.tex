...
\cite{Schymroch} beziffert die Break-Even-Distance auf 300 km bis 700 km. %andere Quellen


% Gliederung für diese Kapitel:
% nicht vermascht ✔
% schlechte Schalter, weil kein Nullpunkt ✔
% Konverterstationen ✔
%% Konverterstationen: teuer, anfällige, aufwendig… ✔
%% hohe Verluste ✔
% geringere Verluste ✔
% weniger Leitungen ✔
% einfachere Leitungen ✔
%% geringere Leitungs-Belastung ✔
%% nidrigere Spannung, das Ueff=Umax ✔
%% kein Skineffekt
%% keine Dielektr. Verluste ; Vorentladung
%% weniger Koronaentladung ✔
%%% -> keine Bündelleiter ✔
% Breack-Even-Point ✔
% keine maximale Leiterlänge
%% Unterseekabel
% Verschmutzungsbla -> WP
% Blinleistungsbereitstellung
% nicht frequenz-Syncron
%% keine Phasenverscheibung durch differenz
%% koppelung versch. Netze
