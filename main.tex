...
\noindent\textbf{Induktivitätsbelag}\: 
...
\begin{equation}
\Phi_{vk} = \int_A B_k dA = \int_{x=d_{vk}}^{x=r_a} \frac{\mu_0i_k l}{2\pi x}dx =
...
\noindent\textbf{Induktivitätsbelag – alt}\: Die Induktivität lässt sich für eine einphasige Leitung wie folgt berechnen:
\begin{equation}
...
%Die Induktivitäten von Kabeln lassen sich ansch den selben vGleichungen berechnen, wei die von Freileitungen, da hier Herleitung dieser ohne die Bedingung $d\gg r$ auskommt.
